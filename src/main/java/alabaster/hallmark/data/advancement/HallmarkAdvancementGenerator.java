...
public class HallmarkAdvancementGenerator implements AdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
        AdvancementHolder hallmark = Advancement.Builder.advancement()
                .display(HallmarkModItems.STAMP.get(),
        ...
        AdvancementHolder blankSlate = getAdvancement(hallmark, HallmarkModItems.STAMP.get(), "blank_slate", AdvancementType.TASK, true, true, false)
                .addCriterion("stamp", InventoryChangeTrigger.TriggerInstance.hasItems(HallmarkModItems.STAMP.get()))
        ...
        AdvancementHolder pressGang = getAdvancement(blankSlate, HallmarkModItems.MINTING_PRESS.get(), "minty", AdvancementType.TASK, true, true, false)
                .addCriterion("minting_press", InventoryChangeTrigger.TriggerInstance.hasItems(HallmarkModItems.MINTING_PRESS.get()))
        ...
        AdvancementHolder demonetized = getAdvancement(legalTender, HallmarkModItems.MINTING_PRESS.get(), "demonetized", AdvancementType.TASK, true, true, false)
        ...
        AdvancementHolder assayer = getAdvancement(hallmark, HallmarkModItems.MONOCLE.get(), "assayer", AdvancementType.TASK, true, true, false)
                .addCriterion("monocle", InventoryChangeTrigger.TriggerInstance.hasItems(HallmarkModItems.MONOCLE.get()))
                .save(consumer, getNameId("main/assayer"));

        AdvancementHolder counterfeit = getAdvancement(makeYourMark, namedStamp(1), "counterfeit", AdvancementType.CHALLENGE, true, true, true)
    ...
    private static ItemStack namedStamp(int generation) {
        ItemStack stack = new ItemStack(HallmarkModItems.STAMP.get());
        stack.set(HallmarkModComponents.STAMP.get(), new StampData(ICON_STAMP_ID, ICON_STAMP_LABEL, generation));
