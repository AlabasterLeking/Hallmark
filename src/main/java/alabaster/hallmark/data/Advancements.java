...
import alabaster.hallmark.data.advancement.HallmarkAdvancementGenerator;
...
public class Advancements extends AdvancementProvider
{
    public Advancements(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
        super(output, lookupProvider, existingFileHelper, List.of(new HallmarkAdvancementGenerator()));
    }
}